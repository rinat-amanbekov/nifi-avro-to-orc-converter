...
public class OrcFlowFileWriter implements Writer, MemoryManager.Callback {
    ...
    private static class RowIndexPositionRecorder implements PositionRecorder {
        private final RowIndexEntry.Builder builder;

        RowIndexPositionRecorder(RowIndexEntry.Builder builder) {
    ...
    private abstract static class TreeWriter {
        ...
        private final RowIndexEntry.Builder rowIndexEntry;
        ...
        TreeWriter(int columnId, ObjectInspector inspector,
            ...
            rowIndexEntry = RowIndexEntry.newBuilder();
        ...
        protected RowIndexEntry.Builder getRowIndexEntry() {
        ...
        void writeStripe(OrcProto.StripeFooter.Builder builder,
            ...
            // stripe statistics
            StripeStatistics.Builder stripeStatsBuilder = StripeStatistics.newBuilder();
        ...
        private void writeStripeStatistics(StripeStatistics.Builder builder,
    ...
    private static class StringTreeWriter extends TreeWriter {
        ...
        void createRowIndexEntry() throws IOException {
            ...
            RowIndexEntry.Builder rowIndexEntry = getRowIndexEntry();
            rowIndexEntry.setStatistics(indexStatistics.serialize());
            indexStatistics.reset();
            RowIndexEntry base = rowIndexEntry.build();
        ...
        switch (treeWriter.inspector.getCategory()) {
            case PRIMITIVE:
                switch (((PrimitiveObjectInspector) treeWriter.inspector).getPrimitiveCategory()) {
                    case BOOLEAN:
                        type.setKind(Type.Kind.BOOLEAN);
                        break;
                    case BYTE:
                        type.setKind(Type.Kind.BYTE);
                        break;
                    case SHORT:
                        type.setKind(Type.Kind.SHORT);
                        break;
                    case INT:
                        type.setKind(Type.Kind.INT);
                        break;
                    case LONG:
                        type.setKind(Type.Kind.LONG);
                        break;
                    case FLOAT:
                        type.setKind(Type.Kind.FLOAT);
                        break;
                    case DOUBLE:
                        type.setKind(Type.Kind.DOUBLE);
                        break;
                    case STRING:
                        type.setKind(Type.Kind.STRING);
                        break;
                    case CHAR:
                    ...
                    case VARCHAR:
                        ...
                        break;
                    case BINARY:
                        type.setKind(Type.Kind.BINARY);
                        break;
                    case TIMESTAMP:
                        type.setKind(Type.Kind.TIMESTAMP);
                        break;
                    case DATE:
                        type.setKind(Type.Kind.DATE);
                        break;
                    case DECIMAL:
                        DecimalTypeInfo decTypeInfo = (DecimalTypeInfo) ((PrimitiveObjectInspector) treeWriter.inspector).getTypeInfo();
                        type.setKind(Type.Kind.DECIMAL);
    ...
    private int writeMetadata() throws IOException {
        ...
        for (StripeStatistics.Builder ssb : treeWriter.stripeStatsBuilders) {
    ...
    private int writeFooter(long bodyLength) throws IOException {
        ...
        for (Map.Entry<String, ByteString> entry : userMetadata.entrySet()) {
            builder.addMetadata(UserMetadataItem.newBuilder()
    ...
    private void updateFileStatistics(StripeStatistics stripeStatistics) {
